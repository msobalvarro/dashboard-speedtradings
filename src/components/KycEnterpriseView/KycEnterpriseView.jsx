    ...
    <section className="kyc__enterprise--view">
      ...
      <div className="two__rows--enterprise">
        <div className="card__information">
          <h3 className="card__information--title">Información empresarial</h3>
        ...
        <div className="card__information">
          <h3 className="card__information--title">Representante legal</h3>
          <div className="auto__columns--enterprise">
            <TextGroup
              label="Nombre"
              value={kycInfo?.legalRepresentative?.fullname || 'Sin datos'}
            />
            <TextGroup
              label="Cargo"
              value={kycInfo?.legalRepresentative?.chargeTitle || 'Sin datos'}
            />
            <TextGroup
              label="Correo"
              value={kycInfo?.legalRepresentative?.email || 'Sin datos'}
            />
            <TextGroup
              label="Teléfono"
              value={
                kycInfo?.legalRepresentative?.telephoneNumber || 'Sin datos'
              }
            />
            <TextGroup
              label="Dirección"
              value={kycInfo?.legalRepresentative?.direction || 'Sin datos'}
            />
          </div>
        </div>
      </div>
      <div className="two__rows--enterprise">
        <div className="card__information">
          ...
          <div className="auto__columns--enterprise">
            <TextGroup
              label="Pais "
              value={getCountry(kycInfo?.permanentCountry) || 'Sin datos'}
            />
            ...
            <div className="table__beneficiaries">
              <div className="table__head--beneficiaries">
                <div className="row--beneficiaries">
                  <span className="table__label--beneficiaries">Nombre</span>
                  <span className="table__label--beneficiaries">Cargo</span>
                  <span className="table__label--beneficiaries">%</span>
                </div>
              </div>
              <div className="table__body--beneficiaries">
                {kycInfo?.beneficiaries.map((beneficiary, index) => (
                  <div key={index}>
                    <div className="row--beneficiaries">
