    ...
    <div className="container-buy-plan">
      ...
      <div className="row wallets">
        {!state.airtm && (
          <>
            ...
            >
              {!state.alypay ? state.wallets[type] : state.wallets.alypay[type]}
            </span>
          </>
        )}
      ...
      <div className="row">
        ...
        <div className="aproximateAmount-legend">
          <p>
            Monto mínimo de inversión: {amountMin[type]} {type.toUpperCase()}
          </p>
          <p>Monto inversión (USD): ${WithDecimals(state.amountDollar)}</p>
        </div>
      </div>
