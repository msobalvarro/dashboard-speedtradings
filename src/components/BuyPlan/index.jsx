        ...
        try {
            ...
            if (state.airtm) {
                ...
                if (state.aproximateAmount === 0) {
                    throw String(
                        'No se ha podido calcular el monto, contacte a soporte'
                    )
                }
            }
                    ...
                    <div className="form__container">
                        <div className="modal__icon--container">
                            {idCrypto === 1 && (
                                <>
                                    <BitcoinIcon
                                        className="buyplan__plan--icon icon-color"
                                        color="#ffcb08"
                                    />

                                    <h2 className="modal__title">
                                        Adquirir plan de Bitcoin
                                    </h2>
                                </>
                            )}
