        ...
        return (
            <article className="card__plan">
                <h1 className="caption">
                    {`Tu plan de ${plan}, se activara cuando sea verificado`}
                </h1>
            </article>
        )
    ...
    return (
        <article className="card__plan">
            ...
            <div className="plan__header">
                <div className="plan__name">
                    ...
                    >
                        {plan === 'bitcoin' ? (
                            <BitcoinIcon
                                className="card__plan--icon icon-color"
                                color="#ffcb08"
                            />
                        ) : (
                            <EthereumIcon
            ...
            <div className="bar__container">
                <div>
                    <p className="plan__value">{`Ganado (${percentage.toFixed(
                        1
                    )}%)`}</p>

                    <div
                        className={`${
                            plan === PLAN.BITCOIN ? 'bar yellow' : 'bar'
                        }`}
                    >
                        <div
