...
const Register = props => {
  ...
  const validationButtons = {
    ...
    second:
      amountPlan !== null &&
      (crypto === 1
        ? amountPlan >= amountMin.btc
        : amountPlan >= amountMin.eth) &&
      hash.length > 10 &&
      walletBTC.length > 10 &&
      walletETH.length > 10 &&
  ...
  const onSubmitInformation = async () => {
    ...
    try {
      ...
      if (data.response === 'success') {
        ...
        throw String(
          'Su registro no se ha podido procesar, contacte a soporte o intentelo mas tarde'
        )
      }
    } catch (error) {
      console.error(error)
  ...
  const validateUsernameSponsor = async (username = '') => {
    ...
    try {
      if (username.length > 0) {
        const { data } = await Petition.post(`/comprobate/username/exist`, {
          username,
        })
  ...
  const onChangeAmountPlan = e => {
    ...
    if (
      ...
      if (airtm) {
        ...
        _amountDollar =
          value !== '0'
            ? calculateCryptoPrice(cryptoPrice, parseFloat(value))
            : 0
  ...
  return (
    <div className="container-register">
      ...
      <div className="form-container">
          ...
          <>
            {validateUserSponsor ? (
              ...
              <div className="sponsor-message invalid">
                Sponsor "{usernameSponsor}" no es valido
              </div>
            )}
          </>
        )}
        ...
        {tabActive === 1 && (
          <div className="tab">
            ...
            <div className="row__register">
              <span className="required comprobate">
                Correo Electrónico
                {loader && <ActivityIndicator size={24} />}
                {validateEmail !== null && (
                  <>
                    {validateEmail ? (
            ...
            <div className="row-group">
              ...
              <div className="col telephone-field">
                <span className="required">
                  Numero telefónico <span>({codeNumber.toString()})</span>
                </span>
            ...
            <div className="collection-buttons">
              ...
              <button
                ...
                disabled={!validationButtons.first}
                onClick={_ => setTab(2)}
              >
                Siguiente
              </button>
        ...
        {tabActive === 2 && (
          <div className="tab">
            ...
            <div className="row-group">
              <div className="col">
                ...
                <select
                  className="picker"
                  value={crypto}
                  onChange={e => setCrypto(parseInt(e.target.value))}
                >
            ...
            <div className="row__register min-amount">
              {crypto === 1 && (
            ...
            <div className="row__register">
              ...
              {!airtm && <span className="required">Hash de transaccion</span>}
            ...
            {airtm && (
              <div className="row__register">
                ...
                <input
                  value={emailAirtm}
                  onChange={e => setEmailAirtm(e.target.value)}
                  type="text"
                  className="text-input"
                />
              </div>
            ...
            <div className="terms">
              ...
              <input
                ...
                checked={term}
                id="terms-input"
                onChange={_ => setTerms(!term)}
              />
            </div>

            <div className="collection-buttons">
              <button className="button no-border" onClick={_ => setTab(1)}>
                Atras
              </button>
              <button
                className="button secondary no-border"
                disabled={!validationButtons.second || loader || loaderData}
      ...
      {modal && <ModalTerms closeModal={_ => setModal(false)} />}
    </div>
  )
}
